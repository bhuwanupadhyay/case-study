...
public class NotificationsRepository extends Notifications {
  ...
  @Override public Optional<Notification> findOne(NotificationId notificationId) {
    return Optional.empty();
  }

  @Override protected void persist(Notification entity) {

  }

  @Override public NotificationId nextId() {
    return null;
  }
}
