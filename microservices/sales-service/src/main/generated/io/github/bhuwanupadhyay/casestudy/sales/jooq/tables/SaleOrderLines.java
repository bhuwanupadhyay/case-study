...
public class SaleOrderLines extends TableImpl<SaleOrderLinesRecord> {
	 ...
	 */
	public final TableField<SaleOrderLinesRecord, Long> ID = createField(DSL.name("id"),
			org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");
	/**
	 * The column <code>public.sale_order_lines.order_id</code>.
	 */
	public final TableField<SaleOrderLinesRecord, String> ORDER_ID = createField(DSL.name("order_id"),
			org.jooq.impl.SQLDataType.VARCHAR(36), this, "");
	/**
	 * The column <code>public.sale_order_lines.item_id</code>.
	 */
	public final TableField<SaleOrderLinesRecord, String> ITEM_ID = createField(DSL.name("item_id"),
			org.jooq.impl.SQLDataType.VARCHAR(36), this, "");
	/**
	 * The column <code>public.sale_order_lines.quantity</code>.
	 */
	public final TableField<SaleOrderLinesRecord, Integer> QUANTITY = createField(DSL.name("quantity"),
