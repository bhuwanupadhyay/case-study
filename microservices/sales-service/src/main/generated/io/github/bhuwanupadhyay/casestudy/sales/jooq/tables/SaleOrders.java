...
public class SaleOrders extends TableImpl<SaleOrdersRecord> {
   ...
   */
  public final TableField<SaleOrdersRecord, Long> ID =
   ...
   */
  public final TableField<SaleOrdersRecord, String> ORDER_ID =
      createField(DSL.name("order_id"), org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this,
          "");

  /**
   * The column <code>public.sale_orders.customer_id</code>.
   */
  public final TableField<SaleOrdersRecord, String> CUSTOMER_ID =
      createField(DSL.name("customer_id"), org.jooq.impl.SQLDataType.VARCHAR(36), this, "");

  /**
   * The column <code>public.sale_orders.status</code>.
   */
  public final TableField<SaleOrdersRecord, String> STATUS =
      createField(DSL.name("status"), org.jooq.impl.SQLDataType.VARCHAR(100), this, "");

  /**
   * The column <code>public.sale_orders.cancellation_reason</code>.
   */
  public final TableField<SaleOrdersRecord, String> CANCELLATION_REASON =
      createField(DSL.name("cancellation_reason"), org.jooq.impl.SQLDataType.VARCHAR(255), this,
          "");

  /**
   * The column <code>public.sale_orders.created_at</code>.
   */
  public final TableField<SaleOrdersRecord, LocalDateTime> CREATED_AT =
      createField(DSL.name("created_at"), org.jooq.impl.SQLDataType.LOCALDATETIME, this, "");
  ...
  public List<UniqueKey<SaleOrdersRecord>> getKeys() {
    return Arrays.<UniqueKey<SaleOrdersRecord>>asList(Keys.PK_SALE_ORDERS,
        Keys.SALE_ORDERS_ORDER_ID_KEY);
  }
